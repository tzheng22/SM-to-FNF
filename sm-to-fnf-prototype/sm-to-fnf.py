                ...
                if len(notes) > 0:
                    if len(notes[o]) > 0:
                        while o < len(notes):
                            ...
                            o += 1
                        if o < len(notes):
                            notes[o].insert(q, [holdtimestamp[x], x, hold[x]])
                        else:
                            notes[o-1].append([holdtimestamp[x], x, hold[x]])
                    else:
                        sectionNotes.append([holdtimestamp[x], x, hold[x]])
                else:
                    sectionNotes.append([holdtimestamp[x], x, hold[x]])
                hold[x] = 0
                holdtimestamp[x] = 0
